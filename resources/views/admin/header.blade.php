...
<body>
    ...
    <div class="admin-mobile-topbar" id="admin-mobile-topbar">
        ...
        <span class="mobile-logo">Orbistransitwayss Admin</span>
    </div>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <a class="navbar-brand" href="/">
                <img src="{{ asset('wp-content/uploads/2022/04/Screenshot_20231009_092214-150x150.png') }}" alt="Orbistransitwayss Logistics" width="50px">
            </a>
        </div>
